CREATE TABLE aiops_shard_r.t_trace_expand (
    `appName` String,
...
ENGINE = ReplicatedMergeTree('/clickhouse/tables/cluster-aiops/t_trace_expand/{r_shard}', '{replica}')
...
CREATE TABLE aiops_shard_r.t_trace_expand_all as aiops_shard_r.t_trace_expand ENGINE = Distributed('cluster-aiops', '', 't_trace_expand', sipHash64(traceId));
