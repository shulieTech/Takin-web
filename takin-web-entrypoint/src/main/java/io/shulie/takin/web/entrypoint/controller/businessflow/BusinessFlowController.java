...
public class BusinessFlowController {
    ...
    public PagingList<BusinessFlowListResponse> getBusinessFlowList(@ApiParam("业务流程ID") Long id, @ApiParam("业务流程名称") String businessFlowName, Integer current, Integer pageSize) {
