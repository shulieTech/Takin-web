...
public class TApplicationInfoUploadVo {
    /**
     * 主键id
     */
    private String taiuId;
     ...
     * @param createTime
     */
    public TApplicationInfoUploadVo(String taiuId, String applicationName, Integer infoType, String uploadInfo,
        Date createTime) {
        this.taiuId = taiuId;
     ...
     * 无参数构造函数
     */
    public TApplicationInfoUploadVo() {
        super();
    }
    ...
    public String toString() {
        return "TApplicationInfoUploadVo{" +
            "taiuId='" + taiuId + '\'' +
