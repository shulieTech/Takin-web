...
/**
* @author zz
* @description 针对表【t_report_base_line_problem】的数据库操作Service实现
* @createDate 2024-03-14 10:56:40
*/
@Service
public class TReportBaseLinkProblemServiceImpl extends ServiceImpl<TReportBaseLinkProblemMapper, TReportBaseLinkProblem>
    implements TReportBaseLinkProblemService {
