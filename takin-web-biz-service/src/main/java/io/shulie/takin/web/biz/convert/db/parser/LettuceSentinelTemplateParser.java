 ...
 */
@Deprecated
public class LettuceSentinelTemplateParser extends AbstractTemplateParser{
    ...
    public Class<?>  getSupperClass() {
        return  RedisTemplate.LettuceSentinelTemplate.class;
    }
    ...
    public <T extends Template> T convertTemplate(AppShadowDatabaseDTO dto) {
        ...
        RedisTemplate.LettuceSentinelTemplate lettuceSentinelTemplate = JSONObject.parseObject(attachment, RedisTemplate.LettuceSentinelTemplate.class);
        return (T) lettuceSentinelTemplate;
    }
}
