...
public interface PressureResourceRelationDsMapper
    ...
    @Insert("<script>" +
            ...
            "shadow_database,shadow_user_name,shadow_password,ext_info,remark,tenant_id,env_code,gmt_create)" +
            "values " +
            ...
            "#{item.shadowPassword},#{item.extInfo},#{item.remark},#{item.tenantId},#{item.envCode},#{item.gmtCreate})" +
            "</foreach>" +
