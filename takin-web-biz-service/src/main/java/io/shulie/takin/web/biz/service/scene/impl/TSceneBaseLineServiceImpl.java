...
/**
* @author zz
* @description 针对表【t_scene_base_line】的数据库操作Service实现
* @createDate 2024-03-12 14:03:23
*/
@Service
public class TSceneBaseLineServiceImpl extends ServiceImpl<TSceneBaseLineMapper, TSceneBaseLine>
    implements TSceneBaseLineService {
