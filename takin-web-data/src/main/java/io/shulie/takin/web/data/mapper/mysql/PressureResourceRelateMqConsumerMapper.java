...
public interface PressureResourceRelateMqConsumerMapper
    ...
    @Insert("<script>" +
            ...
            "resource_id,detail_id,topic_group,mq_type,comsumer_type,is_cluster,application_name,consumer_tag," +
            "feature,type,tenant_id,env_code,gmt_create)" +
            "values " +
            "(#{item.resourceId},#{item.detailId},#{item.topicGroup},#{item.mqType},#{item.comsumerType}," +
