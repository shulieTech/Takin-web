 ...
 */
@Deprecated
public class JedisSentinelTemplateParser extends AbstractTemplateParser{
    ...
    public Class<?>  getSupperClass() {
        return  RedisTemplate.JedisSentinelTemplate.class;
    }
    ...
    public <T extends Template> T convertTemplate(AppShadowDatabaseDTO dto) {
        ...
        RedisTemplate.JedisSentinelTemplate jedisSentinelTemplate = JSONObject.parseObject(attachment, RedisTemplate.JedisSentinelTemplate.class);
