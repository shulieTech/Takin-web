...
public class PtsXmlContentUtils {
    ...
    public static String replaceAndSymbol(String xmlContent) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("encode===" + StringEscapeUtils.escapeXml(str));
        System.out.println("encode===" + StringEscapeUtils.escapeHtml(str));
    }
}
