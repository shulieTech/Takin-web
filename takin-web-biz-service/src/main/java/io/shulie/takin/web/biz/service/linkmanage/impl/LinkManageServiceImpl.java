...
public class LinkManageServiceImpl implements LinkManageService {
    ...
    public Response getBussisnessLinks(BusinessQueryVo vo) {
        ...
        //老版本接口已经使用了
        List<BusinessLinkDto> queryResult = tBusinessLinkManageTableMapper.selectBussinessLinkListBySelective2(queryVo, null);
        //用户ids
    ...
    public Response<List<SceneDto>> getScenes(SceneQueryVo vo) {
        List<SceneDto> sceneDtos = tSceneMapper.selectByRelatedQuery(vo, null);
