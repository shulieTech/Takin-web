package io.shulie.takin.web.entrypoint.controller.pressurecontrol;
...
import com.pamirs.takin.common.constant.ResponseConstant;
...
public class DataBuildController {
    ...
    public ResponseEntity<Object> queryBuildinfo(@RequestBody Map<String, Object> paramMap) {
        try {
            ...
            return ResponseError.create(TakinErrorEnum.BUILDDATA_QUERY_BUILDINFO_EXCEPTION.getErrorCode(),
                TakinErrorEnum.BUILDDATA_QUERY_BUILDINFO_EXCEPTION.getErrorMessage());
        }
    }
    ...
    public ResponseEntity<Object> updateScriptExcuteStatus(@RequestBody Map<String, Object> map) {
        if (map == null || map.isEmpty() || StringUtils.isEmpty(MapUtils.getString(map, "applicationId"))) {
            return ResponseError.create(TakinErrorEnum.BUILDDATA_UPDATE_SCRIPTSTATUS_PARAMLACK.getErrorCode(),
                TakinErrorEnum.BUILDDATA_UPDATE_SCRIPTSTATUS_PARAMLACK.getErrorMessage());
        }
        ...
        try {
            ...
            return ResponseError.create(TakinErrorEnum.BUILDDATA_UPDATE_SCRIPTSTATUS_EXCEPTION.getErrorCode(),
                TakinErrorEnum.BUILDDATA_UPDATE_SCRIPTSTATUS_EXCEPTION.getErrorMessage());
        }
    }
    ...
    public ResponseEntity<Object> queryScriptExcuteStatus(@RequestParam("applicationId") String applicationId,
        ...
        try {
            if (StringUtils.isEmpty(scriptType) || StringUtils.isEmpty(applicationId)) {
                return ResponseError.create(TakinErrorEnum.BUILDDATA_QUERY_SCRIPTSTATUS_PARAMLACK.getErrorCode(),
                    TakinErrorEnum.BUILDDATA_QUERY_SCRIPTSTATUS_PARAMLACK.getErrorMessage());
            }
            ...
            return ResponseError.create(TakinErrorEnum.BUILDDATA_QUERY_SCRIPTSTATUS_EXCEPTION.getErrorCode(),
                TakinErrorEnum.BUILDDATA_QUERY_SCRIPTSTATUS_EXCEPTION.getErrorMessage());
        }
    }
    ...
    public ResponseEntity<Object> batchClean(@RequestParam("applicationIds") String applicationIds) {
        try {
            ...
            return ResponseError.create(TakinErrorEnum.BUILDDATA_QUERY_BATCHCLEAN_EXCEPTION.getErrorCode(),
                TakinErrorEnum.BUILDDATA_QUERY_BATCHCLEAN_EXCEPTION.getErrorMessage());
        }
    }
    ...
    public ResponseEntity<Object> executeScript(@RequestBody Map<String, Object> paraMap) {
        try {
            ...
            return ResponseError.create(TakinErrorEnum.BUILDDATA_EXECUTE_SCRIPT_EXCEPTION.getErrorCode(),
                TakinErrorEnum.BUILDDATA_EXECUTE_SCRIPT_EXCEPTION.getErrorMessage());
        }
    }
