...
public class TFirstLinkMntServiceImpl extends CommonService implements TFirstLinkMntService {
    ...
    @Override
    public void saveLink(TFirstLinkMnt firstLinkMnt) throws TakinModuleException {
        String firstLinkName = firstLinkMnt.getLinkName();
        int linkExist = firstLinkMntDao.saveLinkExist(firstLinkName);
        if (linkExist > 0) {
            throw new TakinModuleException(TakinErrorEnum.CONFCENTER_FIRST_LINK_DUPICATE_EXCEPTION);
        } else {
    ...
    public PageInfo<TFirstLinkMnt> queryLinkList(String firstLinkName, String secondLinkName,
        ...
        if (pageSize == null || pageNum == null) {
            throw new TakinModuleException(TakinErrorEnum.PAGE_PARAM_EXCEPTION);
        }
    ...
    @Override
    public TFirstLinkMnt queryLinkByLinkId(String linkId) throws TakinModuleException {
        TFirstLinkMnt firstLinkMnt = firstLinkMntDao.queryLinkByLinkId(linkId);
        return firstLinkMnt;
    }

    @Override
    public Map<String, Object> queryLinkMapByLinkId(String linkId) throws TakinModuleException {
        TFirstLinkMnt firstLinkMnt = firstLinkMntDao.queryLinkByLinkId(linkId);
        //返回信息中要包含二级链路的id和名称
    ...
    public void deleteLinkByLinkIds(String linkIds) throws TakinModuleException {
    ...
    @Override
    public void updateLinkinfo(TFirstLinkMnt firstLinkMnt) throws TakinModuleException {
        ...
        if (!Objects.isNull(originFirstLinkMnt)) {
            ...
            throw new TakinModuleException(TakinErrorEnum.CONFCENTER_NOT_FOUND_FIRST_LINKID_EXCEPTION);
        }
    }

    @Override
    public Map<String, Object> getLinkTopologyByFirstLinkId(String linkId) throws TakinModuleException {
        //查询拓扑图
        //1，查询出一级链路
