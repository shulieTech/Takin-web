CREATE TABLE stresstest.t_trace_expand (
                                        `appName` String,
...
CREATE TABLE stresstest.t_trace_expand_all as stresstest.t_trace_expand ENGINE = Distributed('cluster-1', 'stresstest', 't_trace_expand', sipHash64(traceId));
