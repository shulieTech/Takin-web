CREATE TABLE default.t_trace_expand (
        `appName` String,
...
CREATE TABLE default.t_trace_expand_all as default.t_trace_expand ENGINE = Distributed('cluster-1', '', 't_trace_expand', sipHash64(traceId));
