...
/**
 * @author -
 * @see com.pamirs.takin.common.util.ProcessUtilsTest
 */
public class ProcessUtils {
     ...
     * @date 2018/8/9 11:10
     */
    public static List<String> getPidList(String commandResult) {
       /*
String s = "appman    4960  4646  0 15:22 ?        00:00:00 /bin/sh /opt/takin/shell/starmqclient.sh
...
ESB MQM2 10.230.29.24 LMS.CLIENT 1428 1208 QU_LMS_REQUEST_COM_IN 1 PT_LMS_ESB2LMS_PRO_TEST";
    ...
    public static List<String> getProcessIdList(String commandResult) {
        ...
        for (String s : afterArray) {
            String[] command = StringUtils.split(s, " ");
            if (command.length < 2) {
                continue;
            }
