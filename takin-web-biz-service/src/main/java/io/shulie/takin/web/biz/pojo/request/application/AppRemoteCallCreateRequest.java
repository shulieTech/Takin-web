...
@Data
@NoArgsConstructor
public class AppRemoteCallCreateRequest  {

    @ApiModelProperty(name = "id", value = "id,有id,则更新")
    private Long id;
    /**
     * 接口名称
     */
     ...
     * mock延迟响应时间，类型2必填
     */
    @ApiModelProperty(name = "mockResponseTime", value = "mock延迟响应时间")
    private String mockResponseTime;
