 ...
 */
@Deprecated
public class JedisClusterTemplateParser extends AbstractTemplateParser{
    /**
     * 返回对应的模板class
     *
     * @return
    ...
    public Class<?>  getSupperClass() {
        return  RedisTemplate.JedisClusterTemplate.class;
    }
    ...
    public <T extends Template> T convertTemplate(AppShadowDatabaseDTO dto) {
        ...
        RedisTemplate.JedisClusterTemplate jedisClusterTemplate = JSONObject.parseObject(attachment, RedisTemplate.JedisClusterTemplate.class);
        return (T) jedisClusterTemplate;
    }
