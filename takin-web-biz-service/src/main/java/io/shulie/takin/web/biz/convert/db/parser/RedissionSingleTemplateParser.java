 ...
 */
@Deprecated
public class RedissionSingleTemplateParser extends AbstractTemplateParser{
    ...
    public Class<?>  getSupperClass() {
        return  RedisTemplate.RedissionSingleTemplate.class;
    }
    ...
    public <T extends Template> T convertTemplate(AppShadowDatabaseDTO dto) {
        ...
        RedisTemplate.RedissionSingleTemplate redissionSingleTemplate = JSONObject.parseObject(attachment, RedisTemplate.RedissionSingleTemplate.class);
        return (T) redissionSingleTemplate;
    }
}
