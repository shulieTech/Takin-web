...
public interface TWhiteListMntDao {
     ...
     * @author shulie
     */
    public List<TApplicationInterface> queryWhiteList(
            @Param("applicationName") String applicationName,
            @Param("principalNo") String principalNo,
            @Param("type") String type);
     ...
     * @author shulie
     */
    public void deleteByIds(@Param("wlistIds") List<Long> whiteListIds);
     ...
     * @author shulie
     */
    public List<Map<String, Object>> queryWhiteListList(
            @Param("applicationName") String applicationName);
     ...
     * @author shulie
     */
    public List<TApplicationInterface> queryOnlyWhiteList(
            @Param("applicationName") String applicationName,
            @Param("principalNo") String principalNo,
            @Param("type") String type,
    ...
    public List<TWList> queryWhiteListTotalByApplicationId(@Param("applicationId") Long applicationId);
     ...
     * @return
     */
    public List<TWList> queryDistinctWhiteListTotalByApplicationId(
            @Param("applicationId") Long applicationId,
