...
public class RedissionSentinelTemplateParser extends AbstractTemplateParser{
    ...
    public Class<?>  getSupperClass() {
        return  RedisTemplate.RedissionSentinelTemplate.class;
    }
    ...
    public <T extends Template> T convertTemplate(AppShadowDatabaseDTO dto) {
        ...
        RedisTemplate.RedissionSentinelTemplate redissionSentinelTemplate = JSONObject.parseObject(attachment, RedisTemplate.RedissionSentinelTemplate.class);
        return (T) redissionSentinelTemplate;
    }
}
