BEGIN;
-- 无涯 基础表
UPDATE t_pradar_zk_config
set TENANT_ID = -1 and env_code = 'system';
...
from t_tenant_info;
update t_scene
set tenant_id = customer_id and env_code = 'prod'
where customer_id in (2, 3, 5, 7, 10, 24);
update t_shadow_job_config
set tenant_id = customer_id and env_code = 'prod'
where customer_id in (2, 3, 5, 7, 10, 24);
update t_shadow_mq_consumer
set tenant_id = customer_id and env_code = 'prod'
where customer_id in (2, 3, 5, 7, 10, 24);
update t_trace_node_info
set tenant_id = customer_id and env_code = 'prod'
where customer_id in (2, 3, 5, 7, 10, 24);
update t_tro_dbresource
set tenant_id = customer_id and env_code = 'prod'
where customer_id in (2, 3, 5, 7, 10, 24);
update t_white_list
set tenant_id = customer_id and env_code = 'prod'
where customer_id in (2, 3, 5, 7, 10, 24);
update t_whitelist_effective_app
set tenant_id = customer_id and env_code = 'prod'
where customer_id in (2, 3, 5, 7, 10, 24);
update t_application_mnt
set tenant_id = customer_id and env_code = 'prod'
where customer_id in (2, 3, 5, 7, 10, 24);
update t_application_ds_cache_manage
set tenant_id = customer_id and env_code = 'prod'
where customer_id in (2, 3, 5, 7, 10, 24);
update t_application_ds_db_manage
set tenant_id = customer_id and env_code = 'prod'
where customer_id in (2, 3, 5, 7, 10, 24);

-- 默认
update t_scene
set tenant_id = customer_id and env_code = 'test'
where customer_id = 1;
update t_shadow_job_config
set tenant_id = customer_id and env_code = 'test'
where customer_id = 1;
...
-- T3出行
update t_scene
set tenant_id = 3 and env_code = 'test'
where customer_id = 4;
update t_shadow_job_config
set tenant_id = 3 and env_code = 'test'
where customer_id = 4;
...
-- 老板姓
update t_scene
set tenant_id = 5 and env_code = 'prod'
where customer_id in (12, 13);
update t_shadow_job_config
set tenant_id = 5 and env_code = 'prod'
where customer_id in (12, 13);
update t_shadow_mq_consumer
...
-- 联动云
update t_scene
set tenant_id = 10 and env_code = 'test'
where customer_id = 9;
update t_shadow_job_config
set tenant_id = 10 and env_code = 'test'
where customer_id = 9;
...
select GROUP_CONCAT(id)
from t_tenant_info;
update t_script_debug
set tenant_id = customer_id and env_code = 'prod'
where customer_id in (2, 3, 5, 7, 10, 24);
update t_script_manage
set tenant_id = customer_id and env_code = 'prod'
where customer_id in (2, 3, 5, 7, 10, 24);
-- 默认
update t_script_debug
...
SET t1.env_code = IFNULL((select env_code from DATA_FIX_TABLE where user_id = t1.user_id), 'test');
...
update t_application_mnt app
set app.tenant_id=IFNULL((select tenant_id from t_tro_user where id = app.user_id), 1);
update t_application_node_probe probe
set probe.tenant_id=IFNULL((select tenant_id from t_application_mnt where APPLICATION_NAME = probe.application_name and customer_id = probe.customer_id), 1);
update t_black_list
set tenant_id=IFNULL((select tenant_id from t_tro_user where id = user_id), 1);
update t_business_link_manage_table
set tenant_id=IFNULL((select tenant_id from t_tro_user where id = user_id), 1);
update t_fast_debug_config_info
set tenant_id=IFNULL((select tenant_id from t_business_link_manage_table where LINK_ID = business_link_id), 1);
update t_fast_debug_result
set tenant_id=IFNULL((select tenant_id from t_fast_debug_config_info where id = config_id), 1);
update t_fast_debug_exception
set tenant_id=IFNULL((select tenant_id from t_fast_debug_result where id = result_id), 1);
update t_script_manage
set tenant_id=IFNULL((select tenant_id from t_tro_user where id = user_id), 1);
UPDATE t_script_manage_deploy t1
    LEFT JOIN t_script_manage t2 ON t1.script_id = t2.id
...
update t_leakcheck_config
set tenant_id=IFNULL((select tenant_id from t_tro_user where id = user_id), 1);
update t_leakcheck_config_detail
set tenant_id=IFNULL((select tenant_id from t_tro_user where id = user_id), 1);
update t_leakverify_result
set tenant_id=IFNULL((select tenant_id from t_tro_user where id = user_id), 1);
update t_operation_log
set tenant_id=IFNULL((select tenant_id from t_tro_user where id = user_id), 1);
update t_ops_script_manage
set tenant_id=IFNULL((select tenant_id from t_tro_user where id = user_id), 1);
update t_link_guard
set tenant_id=IFNULL((select tenant_id from t_tro_user where id = user_id), 1);
...
update t_tro_dbresource
set tenant_id=IFNULL((select tenant_id from t_tro_user where id = user_id), 1);
update t_application_plugins_config
set tenant_id=IFNULL((select tenant_id from t_tro_user where id = user_id), 1);
update t_application_focus
set tenant_id=IFNULL((select tenant_id from t_application_mnt where APPLICATION_NAME = app_name), 1);
update t_application_middleware t
set tenant_id=IFNULL((select tenant_id from t_application_mnt where APPLICATION_ID = t.application_id), 1);
update t_data_build t
set t.tenant_id=(select tenant_id from t_application_mnt where APPLICATION_ID = t.APPLICATION_ID);
update t_datasource_tag_ref t
set t.tenant_id=IFNULL((select tenant_id from t_tro_dbresource where id = t.datasource_id), 1);
update t_leakverify_detail t
set t.tenant_id=IFNULL((SELECT tenant_id FROM t_leakverify_result WHERE id = t.result_id and is_deleted = 0), 1);
update t_link_detection t
set t.tenant_id=IFNULL((select tenant_id from t_application_mnt where APPLICATION_ID = t.APPLICATION_ID), 1);
update t_login_record t
set t.tenant_id=IFNULL((select tenant_id from t_tro_user WHERE name = t.user_name and is_delete = 0), 1);
update t_ops_script_batch_no t
set t.tenant_id=IFNULL((select tenant_id from t_ops_script_manage WHERE id = t.ops_script_id and is_deleted = 0), 1);
update t_ops_script_execute_result t
set t.tenant_id=IFNULL((select tenant_id from t_ops_script_manage WHERE id = t.ops_script_id and is_deleted = 0), 1);
update t_ops_script_file t
set t.tenant_id=IFNULL((select tenant_id from t_ops_script_manage WHERE id = t.ops_script_id and is_deleted = 0), 1);
update t_performance_base_data t
set t.tenant_id= IFNULL((select tenant_id from t_application_mnt where APPLICATION_NAME = t.app_name), 1);
update t_performance_criteria_config t
set t.tenant_id= IFNULL((select tenant_id from t_application_mnt where APPLICATION_ID = t.app_id), 1);
-- 更新 t_scene_link_relate
UPDATE t_scene_link_relate t1
    LEFT JOIN t_scene t2 ON t1.SCENE_ID = t2.id
SET t1.tenant_id = t2.tenant_id;
...
UPDATE t_activity_node_service_state a
    LEFT JOIN (SELECT IFNULL(u.tenant_id, 1) tid, b.LINK_ID bid, b.env_code
               FROM t_business_link_manage_table b
                        LEFT JOIN t_tro_user u ON u.id = b.USER_ID) t
    ON t.bid = a.activity_id
SET a.tenant_id = IFNULL(t.tid, 1),
    a.env_code  = IFNULL(t.env_code, 'test');

-- t_agent_config 根据 key, 获得用户id, 然后获得 租户id
UPDATE t_agent_config m LEFT JOIN t_tro_user u ON u.`name` = m.operator
...
UPDATE t_app_business_table_info m LEFT JOIN t_tro_user u ON u.id = m.user_id
SET m.tenant_id = IFNULL(u.tenant_id, 1);
UPDATE t_app_business_table_info m LEFT JOIN t_application_mnt u ON u.APPLICATION_ID = m.APPLICATION_ID
SET m.env_code = IFNULL(u.env_code, 'test');

-- t_app_middleware_info 根据用户id查到租户id, 然后赋值
UPDATE t_app_middleware_info m LEFT JOIN t_tro_user u ON u.id = m.user_id
SET m.tenant_id = IFNULL(u.tenant_id, 1);
UPDATE t_app_middleware_info m LEFT JOIN t_application_mnt u ON u.APPLICATION_ID = m.APPLICATION_ID
SET m.env_code = IFNULL(u.env_code, 'test');

UPDATE t_app_remote_call m LEFT JOIN t_tro_user u ON u.id = m.user_id
SET m.tenant_id = IFNULL(u.tenant_id, 1);
UPDATE t_app_remote_call m LEFT JOIN t_application_mnt u ON u.APPLICATION_ID = m.APPLICATION_ID
SET m.env_code = IFNULL(u.env_code, 'test');

UPDATE t_app_agent_config_report m LEFT JOIN t_tro_user u ON u.id = m.user_id
SET m.tenant_id = u.tenant_id;
UPDATE t_app_agent_config_report m LEFT JOIN t_application_mnt u ON u.APPLICATION_ID = m.application_id
SET m.env_code = IFNULL(u.env_code, 'test');
...
set tenant_id=1,
    ...
    user_id=1
where customer_id = 1;;
update e_patrol_scene a,t_tenant_info b
set a.tenant_app_key = b.`key`
where a.tenant_id = b.id
  and a.tenant_id is not null;

update e_patrol_activity_assert
set env_code='test',
    tenant_id=1;

update e_patrol_board
set tenant_id=7,
    env_code='prod',
    user_id=7
where customer_id = 7;
...
update e_patrol_board_scene
set env_code='test',
    tenant_id=1;

update e_patrol_exception
set env_code='test',
    tenant_id=1;
update e_patrol_exception a,e_patrol_scene b
set a.user_id= b.user_id
where a.scene_id = b.id
  and a.scene_id <> '-1';

-- 必须先订正数据才能加索引，否则会有冲突
update e_patrol_exception_config
set tenant_id=7,
    env_code='test'
where customer_id = 7;
update e_patrol_exception_config
...
where customer_id = 1;;
delete
from e_patrol_exception_config
where customer_id is null;
ALTER TABLE `e_patrol_exception_config`
    ADD UNIQUE INDEX `idx_config` (`tenant_id`, `env_code`, `type_value`, `level_value`) USING BTREE;

INSERT INTO `e_patrol_exception_config`(`order_number`, `type_value`, `level_value`, `threshold_value`, `contrast_factor`, `remarks`, `tenant_id`, `env_code`)
VALUES (1, 1, 1, 100.00, 1, '一般卡慢', -1, 'system');
INSERT INTO `e_patrol_exception_config`(`order_number`, `type_value`, `level_value`, `threshold_value`, `contrast_factor`, `remarks`, `tenant_id`, `env_code`)
VALUES (0, 1, 2, 230.00, 1, '严重卡慢', -1, 'system');
INSERT INTO `e_patrol_exception_config`(`order_number`, `type_value`, `level_value`, `threshold_value`, `contrast_factor`, `remarks`, `tenant_id`, `env_code`)
VALUES (1, 2, 1, 90.00, -1, '一般瓶颈', -1, 'system');
INSERT INTO `e_patrol_exception_config`(`order_number`, `type_value`, `level_value`, `threshold_value`, `contrast_factor`, `remarks`, `tenant_id`, `env_code`)
VALUES (0, 2, 2, 80.00, -1, '严重瓶颈', -1, 'system');
INSERT INTO `e_patrol_exception_config`(`order_number`, `type_value`, `level_value`, `threshold_value`, `contrast_factor`, `remarks`, `tenant_id`, `env_code`)
VALUES (1, 4, 1, 30.00, 1, '一般慢SQL', -1, 'system');
INSERT INTO `e_patrol_exception_config`(`order_number`, `type_value`, `level_value`, `threshold_value`, `contrast_factor`, `remarks`, `tenant_id`, `env_code`)
VALUES (0, 4, 2, 60.00, 1, '严重慢SQL', -1, 'system');

update e_patrol_exception_notice_config
set env_code='test',
    tenant_id=1;

update e_patrol_scene_chain
set env_code='test',
    tenant_id=1;
update e_patrol_scene_check
set env_code='test',
    tenant_id=1;
...
UPDATE t_application_ds_db_table m LEFT JOIN t_application_mnt u ON u.APPLICATION_ID = m.app_id
SET m.env_code  = IFNULL(u.env_code, 'test'),
    m.tenant_id = IFNULL(u.tenant_id, 1);
UPDATE t_application_ds_db_manage m LEFT JOIN t_application_mnt u ON u.APPLICATION_ID = m.APPLICATION_ID
SET m.env_code  = IFNULL(u.env_code, 'test'),
    m.tenant_id = IFNULL(u.tenant_id, 1);
UPDATE t_shadow_mq_consumer m LEFT JOIN t_application_mnt u ON u.APPLICATION_ID = m.application_id
SET m.env_code  = IFNULL(u.env_code, 'test'),
    m.tenant_id = IFNULL(u.tenant_id, 1);
UPDATE t_application_api_manage m LEFT JOIN t_application_mnt u ON u.APPLICATION_ID = m.APPLICATION_ID
SET m.env_code = IFNULL(u.env_code, 'test'),
    m.tenant_id=IFNULL(u.tenant_id, 1);
UPDATE t_application_ds_cache_manage m LEFT JOIN t_application_mnt u ON u.APPLICATION_ID = m.APPLICATION_ID
SET m.env_code = IFNULL(u.env_code, 'test'),
    m.tenant_id=IFNULL(u.tenant_id, 1);
UPDATE t_pradar_zk_config
set TENANT_ID = -1 and env_code = 'system';
...
SET t1.env_code = IFNULL(t2.env_code, 'test');
UPDATE t_fast_debug_stack_info f
SET f.tenant_id=IFNULL((SELECT t.tenant_id from t_fast_debug_result t WHERE t.trace_id = f.trace_id AND t.is_deleted = 0), 1);
-- t_fast_debug_machine_performance
UPDATE t_fast_debug_machine_performance t1
    LEFT JOIN t_fast_debug_result t2 ON t1.trace_id = t2.trace_id
SET t1.env_code = IFNULL(t2.env_code, 'test');
UPDATE t_fast_debug_machine_performance f
SET f.tenant_id=IFNULL((SELECT t.tenant_id from t_fast_debug_result t WHERE t.trace_id = f.trace_id AND t.is_deleted = 0), 1);
...
ALTER TABLE `t_datasource_tag_ref`
    ADD INDEX `idx_tenant_env` (`tenant_id`, `env_code`);
ALTER TABLE t_datasource_tag_ref
    ADD UNIQUE KEY `idx_datasource_tag_tenant_env` (`datasource_id`, `tag_id`, `tenant_id`, `env_code`);
...
ALTER TABLE `t_fast_debug_config_info`
    ADD INDEX `idx_tenant_env` (`tenant_id`, `env_code`);
ALTER TABLE t_fast_debug_config_info
    ADD UNIQUE KEY `idx_name_tenant_env` (`name`, `tenant_id`, `env_code`);
...
ALTER TABLE `t_middleware_info`
    ADD UNIQUE INDEX `idx_name_version_tenant_env` (`MIDDLEWARE_NAME`, `MIDDLEWARE_VERSION`, `tenant_id`, `env_code`);
...
ALTER TABLE t_fast_debug_config_info
    DROP INDEX `name`;
ALTER TABLE t_application_api_manage
    DROP INDEX IF EXISTS `APPLICATION_NAME`;
ALTER TABLE t_datasource_tag_ref
    DROP INDEX `index_datasourceId_tagId`;
...
ALTER TABLE `t_exception_info`
    ADD INDEX `idx_agent_code` (`agent_code`);
...
-- 权限表
ALTER TABLE t_tro_authority
    ADD UNIQUE INDEX `unique_idx_role_id_resource_id_tenant_env` (`tenant_id`, `env_code`, `resource_id`, `role_id`) USING BTREE;
