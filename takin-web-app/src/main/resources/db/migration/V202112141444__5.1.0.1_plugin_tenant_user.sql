...
INSERT IGNORE INTO `t_config_server` ( `key`, `value`, `tenant_id`, `env_code`, `tenant_app_key`, `is_tenant`, `is_global`, `edition`, `gmt_create`, `gmt_update`, `is_deleted`) VALUES ('takin.asset.balance.default.try', '10000', -99, 'test', 'default', 0, 1, 2, '2021-12-03 18:22:46', '2021-12-20 10:15:52', 0);
INSERT IGNORE INTO `t_config_server` ( `key`, `value`, `tenant_id`, `env_code`, `tenant_app_key`, `is_tenant`, `is_global`, `edition`, `gmt_create`, `gmt_update`, `is_deleted`) VALUES ('takin.asset.balance.default.formal', '100000', -99, 'test', 'default', 0, 1, 2, '2021-12-03 18:22:46', '2021-12-20 10:15:55', 0);
