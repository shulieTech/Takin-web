 ...
 * @date 2017年11月24日
 */
public enum TakinErrorEnum implements ExceptionReadable {
    ...
    CONFCENTER_ADD_APPLICATION_NONUSER_EXCEPTION(1010100192, "用户信息不存在，添加失败"),
    ...
    //影子表 配置
    API_TAKIN_CONFCENTER_SHADOWCONFIG_PRADAR_GET_EXCEPTION(1010800101, "获取影子表配置异常"),
    API_TAKIN_CONFCENTER_SHADOWCONFIG_UPDATE_PARAM_EXCEPTION(1010800201, "更新影子表配置缺少参数"),
    API_TAKIN_CONFCENTER_SHADOWCONFIG_QUERY_ID_EXCEPTION(1010800202, "通过主键ID未查询到影子表数据"),
    API_TAKIN_CONFCENTER_SHADOWCONFIG_DATASOURCE_ID_EXCEPTION(1010800203, "通过数据源ID未查询到影子表数据源"),
    API_TAKIN_CONFCENTER_SHADOWCONFIG_UPDATE_SAME_EXCEPTION(1010800203, "更新成相同配置表名"),
    API_TAKIN_CONFCENTER_SHADOWCONFIG_DELETE_EXCEPTION(1010800301, "批量删除id 参数为空"),
    API_TAKIN_CONFCENTER_SHADOWCONFIG_ADD_PARAM_EXCEPTION(1010800401, "新增影子表配置缺少参数"),
    API_TAKIN_CONFCENTER_SHADOWCONFIG_TABLENAME_LONG_EXCEPTION(1010800402, "添加的表名太长"),
    API_TAKIN_CONFCENTER_SHADOWCONFIG_GET_FROM_PRADAR_EXCEPTION(1010800501, "从pradar获取影子表配置异常"),
    API_TAKIN_CONFCENTER_SHADOWCONFIG_QUERY_IPPORT_List_EXCEPTION(1010800701, "根据应用ID查询应用数据库IP端口列表异常"),
    API_TAKIN_CONFCENTER_SHADOWCONFIG_QUERY_DBNAME_List_EXCEPTION(1010800801, "根据应用ID查询应用库名列表异常"),
    //影子库数据源
    API_TAKIN_CONFCENTER_SHADOW_DATASOURCE_SAVE_EXCEPTION(1010900101, "新增影子库数据源参数缺少"),
    API_TAKIN_CONFCENTER_SHADOW_DATASOURCE_EXIST_EXCEPTION(1010900201, "该影子库数据源已经存在"),
    API_TAKIN_CONFCENTER_SHADOW_DATASOURCE_UPDATE_EXCEPTION(1010900101, "更新影子库数据源参数缺少"),
    API_TAKIN_CONFCENTER_SHADOW_DATASOURCE_IPPORT_EXCEPTION(1010900301, "影子库数据源IP端口格式不正确"),
    //应用开关配置
    API_TAKIN_CONFCENTER_APPLICATION_PARAM_EXCEPTION(1011000001, "更新应用配置参数为空"),
    API_TAKIN_CONFCENTER_APPLICATION_CONFIG_PAGE_EXCEPTION(1011000002, "查询应用程序分页异常"),
    API_TAKIN_CONFCENTER_APPLICATION_CONFIG_UPDATE_EXCEPTION(1011000003, "更新应用开关配置异常"),
    API_TAKIN_CONFCENTER_APPLICATION_CONFIG_BATCH_UPDATE_PARAM_EXCEPTION(1011001001, "批量更新参数为空"),
    API_TAKIN_CONFCENTER_APPLICATION_CONFIG_CHEAT_CHECK_PARAM_EXCEPTION(1011002001, "作弊检查参数异常"),
    //基础配置
    API_TAKIN_CONFCENTER_BASE_CONFIG_QUERY_EXCEPTION(1012000001, "查询基础配置异常"),
    API_TAKIN_CONFCENTER_UPDATE_BASE_CONFIG_PARAM_EXCEPTION(1012000101, "更新基础配置参数为空"),
    API_TAKIN_CONFCENTER_UPDATE_BASE_CONFIG_VALUE_TOO_LONG_EXCEPTION(1012000201, "基础配置值长度太长"),
    API_TAKIN_CONFCENTER_ADD_BASE_CONFIG_EXIST(1012000201, "基础配置code已存在"),
    API_TAKIN_CONFCENTER_UPDATE_BASE_CONFIG_EXCEPTION(1012000102, "更新基础配置异常"),
    API_TAKIN_CONFCENTER_ADD_BASE_CONFIG_EXCEPTION(1012000103, "新增基础配置异常"),
    //透明流量的链路拓扑图配置
    ...
    MONITOR_SCENARIOCONtakinL_EXCEPTION(1030100108, "压测控制接口调用异常"),
    MONITOR_SCENARIOCONtakinL_START_EXCEPTION(1030100501, "压测控制接口启动调用异常"),
    MONITOR_SCENARIOCONtakinL_STOP_EXCEPTION(1030100502, "压测控制接口停止调用异常"),
    MONITOR_SCENARIOCONtakinL_ORDER_EXCEPTION(1030100503, "压测控制接口指令参数异常"),
    MONITOR_SCENARIOCONtakinL_ASWAN_EXCEPTION(1030100504, "压测控制调用阿斯旺接口异常"),
    MONITOR_SCENARIOCONtakinL_RUNNING_EXCEPTION(1030100506, "该链路正在压测"),
    MONITOR_SCENARIOCONtakinL_SHADOWLIB_CHECK_EXCEPTION(1030100507, "请先进行影子库整体同步检测"),
    MONITOR_SCENARIOCONtakinL_WLIST_CHECK_EXCEPTION(1030100508, "请先进行白名单校验状态"),
    MONITOR_SCENARIOCONtakinL_CACHE_CHECK_EXCEPTION(1030100509, "请先进行缓存预热校验状态检测"),
    MONITOR_SCENARIOCONtakinL_NOT_RUNNING_EXCEPTION(1030100510, "该链路没有压测"),
     ...
     * @version 1.0
     */
    private TakinErrorEnum(int errorCode, String errorMessage) {
