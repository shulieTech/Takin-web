...
public class RedissionClusterTemplateParser extends AbstractTemplateParser{
    ...
    public Class<?>  getSupperClass() {
        return  RedisTemplate.RedissionClusterTemplate.class;
    }
    ...
    public <T extends Template> T convertTemplate(AppShadowDatabaseDTO dto) {
        ...
        RedisTemplate.RedissionClusterTemplate redissionClusterTemplate = JSONObject.parseObject(attachment, RedisTemplate.RedissionClusterTemplate.class);
        return (T) redissionClusterTemplate;
    }
}
