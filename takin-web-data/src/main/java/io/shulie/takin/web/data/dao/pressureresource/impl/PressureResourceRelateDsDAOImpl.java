...
public class PressureResourceRelateDsDAOImpl implements PressureResourceRelateDsDAO {
    ...
    @Override
    public List<RelateDsEntity> queryByParam_v2(PressureResourceDsQueryParam param) {
        QueryWrapper<PressureResourceRelateDsEntityV2> queryWrapper = this.getWrapper_v2(param);
        ...
        List<RelateDsEntity> rsList = Lists.newArrayList();
        // 转换下所有数据源关联信息
        for (int i = 0; i < resultLists.size(); i++) {
            ...
            RelateDsEntity dsEntity = RelateConvert.dsManageConvertRelateDs(dsDbManageDetailResult);
    ...
    private QueryWrapper<PressureResourceRelateDsEntityV2> getWrapper_v2(PressureResourceDsQueryParam param) {
