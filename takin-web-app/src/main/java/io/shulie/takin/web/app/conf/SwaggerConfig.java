...
public class SwaggerConfig {
    ...
    public Docket apiV4() {
        return new Docket(DocumentationType.SWAGGER_2)
            .groupName("压测平台-V4版本")
            .select().apis(RequestHandlerSelectors.withClassAnnotation(Api.class)).paths(PathSelectors.regex("/api/(scriptDebug|scriptManage|v2/file|config|probe|v2/application/node|agent/application/node/probe|application/middleware|login).*|/agent.*")).build()
