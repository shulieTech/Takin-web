...
WHERE table_schema = DATABASE() AND TABLE_NAME = 't_app_remote_call' AND COLUMN_NAME = 'manual_tag');
...
SET count1 = (SELECT COUNT(*) FROM `t_app_remote_call_template_mapping` WHERE `interfaceType` = 'httpclient3');
...
INSERT INTO `t_connectpool_config_template` VALUES (2, 'hikari', '连接池', 'hikari', 1, 1, 1, 1, 'driverClassName,maximumPoolSize', 0, NULL, NULL, 0, 0, '2021-10-08 11:24:10', '2021-10-08 11:24:10', 0);
...
INSERT INTO `t_connectpool_config_template` VALUES (4, 'proxool', '连接池', 'proxool', 1, 1, 1, 1, 'driverClassName,alias', 0, NULL, NULL, 0, 0, '2021-10-10 21:52:14', '2021-10-10 21:52:14', 0);
...
INSERT INTO `t_connectpool_config_template` VALUES (8, '兼容老版本(影子库)', '连接池', '兼容老版本(影子库)', 1, 0, 1, 0, NULL, 0, NULL, NULL, 0, 0, '2021-10-10 21:53:13', '2021-10-10 21:53:13', 0);
INSERT INTO `t_connectpool_config_template` VALUES (9, '兼容老版本(影子表)', '连接池', '兼容老版本(影子表)', 1, 1, 0, 0, NULL, 0, NULL, NULL, 0, 0, '2021-10-20 15:30:59', '2021-10-20 15:30:59', 0);
...
INSERT INTO `t_http_client_config_template`  VALUES (5, 'google-httpclient', 'http', 'google-httpclient', 1, 1, 1, '返回mock', 1, '转发', 0, NULL, NULL, 0, 0, 0, '2021-09-09 15:34:12', '2021-09-09 15:34:12');
...
INSERT INTO `t_mq_config_template`  VALUES (1, 'RabbitMQ', 'MQ', 'RABBITMQ', 1, 1, 0, NULL, NULL, 0, 0, '2021-09-09 14:15:02', '2021-09-09 14:15:02', 0);
INSERT INTO `t_mq_config_template`  VALUES (2, 'RocketMQ', 'MQ', 'ROCKETMQ', 1, 1, 0, NULL, NULL, 0, 0, '2021-09-09 14:15:29', '2021-09-09 14:15:29', 0);
INSERT INTO `t_mq_config_template`  VALUES (3, 'KafKa', 'MQ', 'KAFKA', 1, 1, 0, NULL, NULL, 0, 0, '2021-09-09 14:15:47', '2021-09-09 14:15:47', 0);


INSERT INTO `t_rpc_config_template` VALUES (1, 'dubbo', 'rpc', 'dubbo', 1, 1, 1, 'mock', 0, 'mock', 0, NULL, NULL, 0, 0,  0, '2021-09-09 15:25:35', '2021-09-09 15:25:35');
INSERT INTO `t_rpc_config_template` VALUES (2, 'grpc', 'rpc', 'grpc', 1, 1, 0, 'mock', 0, 'mock', 0, NULL, NULL, 0, 0,  0, '2021-09-09 15:25:35', '2021-09-09 15:25:35');
INSERT INTO `t_rpc_config_template` VALUES (3, 'feign', 'rpc', 'feign', 1, 1, 1, 'mock', 0, 'mock', 0, NULL, NULL, 0, 0,  0, '2021-09-09 15:25:35', '2021-09-09 15:25:35');


INSERT INTO `t_base_config` (`CONFIG_CODE`, `CONFIG_VALUE`, `CONFIG_DESC`, `USE_YN`, `CREATE_TIME`, `UPDATE_TIME`) VALUES ('SHADOW_REDIS_cluster', '{\n       \"nodes\":\"192.168.1.241:6379\",\n       \"password\":\"123456\",\n       \"database\":0\n}', '影子redis集群模式配置模版', 0, NULL, '2021-10-13 15:47:50');
INSERT INTO `t_base_config` (`CONFIG_CODE`, `CONFIG_VALUE`, `CONFIG_DESC`, `USE_YN`, `CREATE_TIME`, `UPDATE_TIME`) VALUES ('SHADOW_REDIS_masterSlave', '{\n      \"master\":\"192.168.2.240\",\n       \"nodes\":\"192.168.1.241:6379,192.168.1.241:6380\",\n       \"password\":\"123456\",\n       \"database\":0\n}', '影子redis主从模式配置模版', 0, NULL, '2021-10-13 15:48:49');
INSERT INTO `t_base_config` (`CONFIG_CODE`, `CONFIG_VALUE`, `CONFIG_DESC`, `USE_YN`, `CREATE_TIME`, `UPDATE_TIME`) VALUES ('SHADOW_REDIS_replicated', '{\n       \"nodes\":\"192.168.1.241:6379\",\n       \"password\":\"123456\",\n       \"database\":0\n}\n', '影子redis云托管模式配置模版', 0, NULL, '2021-10-13 15:49:03');
INSERT INTO `t_base_config` (`CONFIG_CODE`, `CONFIG_VALUE`, `CONFIG_DESC`, `USE_YN`, `CREATE_TIME`, `UPDATE_TIME`) VALUES ('SHADOW_REDIS_sentinel', '{\n       \"master\": \"mymaster\",\n       \"nodes\":\"192.168.1.241:6379\",\n       \"password\":\"123456\",\n       \"database\":0\n}', '影子redis哨兵模式配置模版', 0, NULL, '2021-10-14 10:02:58');
INSERT INTO `t_base_config` (`CONFIG_CODE`, `CONFIG_VALUE`, `CONFIG_DESC`, `USE_YN`, `CREATE_TIME`, `UPDATE_TIME`) VALUES ('SHADOW_REDIS_single', '{\n       \"nodes\":\"192.168.1.241:6379\",\n       \"password\":\"123456\",\n       \"database\":0\n}', '影子redis单机模式配置模版', 0, NULL, '2021-10-13 15:49:16');
