...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='影子消费者';
...
WHERE table_schema = DATABASE() AND TABLE_NAME = 't_tro_resource' AND COLUMN_NAME = 'sequence' AND COLUMN_NAME = 'code');
...
SET count1 = (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS
WHERE table_schema = DATABASE() AND TABLE_NAME = 't_application_api_manage' AND COLUMN_NAME = 'customer_id' AND COLUMN_NAME = 'user_id');
...
WHERE table_schema = DATABASE() AND TABLE_NAME = 't_application_api_manage' AND COLUMN_NAME = 'IS_AGENT_REGISTE');
