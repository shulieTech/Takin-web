...
(
    ...
    `key`            varchar(512)  NULL COMMENT '租户key 唯一，同时也是userappkey',
    `name`           varchar(512)   NULL COMMENT '租户名称',
    `nick`           varchar(512)   NULL COMMENT '租户中文名称',
    `code`           varchar(512)   NULL COMMENT '租户代码',
    `config`       	 varchar(1024)  DEFAULT "" COMMENT '租户配置',
    `status`         tinyint(1)     NULL DEFAULT '1' COMMENT '状态 0: 停用 1:正常 2：欠费 3：试用',
...
(
    ...
    `env_code`       varchar(512)   NULL COMMENT '环境代码，测试环境：test,生产环境：prod',
    `env_name`       varchar(1024)  NULL COMMENT '环境名称',
...
----- 流川 -----
-- tenant_id
ALTER TABLE e_patrol_activity_assert ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE e_patrol_board ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE e_patrol_board_scene ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE e_patrol_exception ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE e_patrol_exception_config ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE e_patrol_exception_notice_config ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE e_patrol_exception_status_change_log ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE e_patrol_scene ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE e_patrol_scene_chain ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE e_patrol_scene_check ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE job_execution_log ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE job_status_trace_log ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pradar_app_agent ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pradar_app_bamp ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pradar_app_group ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pradar_app_info ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pradar_app_point ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pradar_app_warn ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pradar_biz_key_config ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pradar_user_login ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pt_t_ac_account ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pt_t_ac_account_book ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pt_t_app_middleware_info ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pt_t_application_mnt ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pt_t_report ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pt_t_return_data ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pt_t_scene_business_activity_ref ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pt_t_scene_manage ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pt_t_scene_script_ref ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT  '租户 id, 默认 1';
ALTER TABLE pt_t_scene_sla_ref ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pt_t_tro_user ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE pt_user ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE t_abstract_data ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE t_ac_account ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE t_ac_account_balance ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE t_ac_account_book ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE t_activity_node_service_state ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE t_agent_config ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE t_agent_plugin ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE t_agent_plugin_lib_support ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE t_agent_version ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE t_alarm_list ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE t_app_agent_config_report ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE t_app_business_table_info ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE t_app_middleware_info ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE t_app_remote_call ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';
ALTER TABLE t_application_api_manage ADD COLUMN `tenant_id` bigint(0) NULL  COMMENT '租户 id, 默认 1';

-- env_code
ALTER TABLE e_patrol_activity_assert ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE e_patrol_board ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE e_patrol_board_scene ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE e_patrol_exception ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE e_patrol_exception_config ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE e_patrol_exception_notice_config ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE e_patrol_exception_status_change_log ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE e_patrol_scene ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE e_patrol_scene_chain ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE e_patrol_scene_check ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE job_execution_log ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE job_status_trace_log ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pradar_app_agent ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pradar_app_bamp ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pradar_app_group ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pradar_app_info ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pradar_app_point ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pradar_app_warn ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pradar_biz_key_config ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pradar_user_login ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pt_t_ac_account ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pt_t_ac_account_book ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pt_t_app_middleware_info ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pt_t_application_mnt ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pt_t_report ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pt_t_return_data ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pt_t_scene_business_activity_ref ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pt_t_scene_manage ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pt_t_scene_script_ref ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pt_t_scene_sla_ref ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pt_t_tro_user ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE pt_user ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE t_abstract_data ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE t_ac_account ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE t_ac_account_balance ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE t_ac_account_book ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE t_activity_node_service_state ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE t_agent_config ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE t_agent_plugin ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE t_agent_plugin_lib_support ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE t_agent_version ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE t_alarm_list ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE t_app_agent_config_report ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE t_app_business_table_info ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE t_app_middleware_info ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE t_app_remote_call ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
ALTER TABLE t_application_api_manage ADD COLUMN `env_code` varchar(100) NULL  COMMENT '环境标识' ;
...
alter table t_pradar_zk_config
    ADD COLUMN `tenant_id` bigint(20)  NULL  COMMENT '租户id',
	  ADD COLUMN `env_code`  varchar(20) NULL   COMMENT '环境变量' AFTER `tenant_id`;
alter table t_pradar_zk_config
    ADD INDEX `idx_tenant_env` ( `tenant_id`,`env_code` );
-- 已有索引 idx_zk_path
