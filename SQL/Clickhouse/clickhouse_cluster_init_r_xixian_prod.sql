...
CREATE TABLE aiops_shard_r.t_engine_metrics_all as aiops_shard_r.t_engine_metrics ENGINE = Distributed ('cluster-aiops','','t_engine_metrics',sipHash64 ( job_id ));
...
CREATE TABLE aiops_shard_r.t_engine_pressure_all as aiops_shard_r.t_engine_pressure ENGINE = Distributed ('cluster-aiops','','t_engine_pressure',sipHash64 ( job_id ));
...
CREATE TABLE aiops_shard_r.t_app_base_data_all as aiops_shard_r.t_app_base_data ENGINE = Distributed ('cluster-aiops','','t_app_base_data',sipHash64 ( app_name ));
...
CREATE TABLE aiops_shard_r.t_performance_base_data_all as aiops_shard_r.t_performance_base_data ENGINE = Distributed ('cluster-aiops','','t_performance_base_data',sipHash64 ( app_name ));
...
CREATE TABLE aiops_shard_r.trace_metrics_all as aiops_shard_r.trace_metrics ENGINE = Distributed ('cluster-aiops','','trace_metrics',sipHash64 ( traceId ));
...
CREATE TABLE aiops_shard_r.trace_e2e_assert_metrics_all as aiops_shard_r.trace_e2e_assert_metrics ENGINE = Distributed ('cluster-aiops','','trace_e2e_assert_metrics',sipHash64 ( traceId ));
