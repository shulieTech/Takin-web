...
public class DateUtils {
     ...
     * @time：2017年9月18日 下午6:14:37
     */
    public static Date getPreviousNSecond(Date currentDate, int n) {
        Calendar calendar = Calendar.getInstance();
    ...
    public static String returnPreMin(Date date, int min) {
        return transferDateToString(returnPreMinToDate(date, min));
    }
    ...
    public static String returnPreSecond(Date date, int second) {
        return transferDateToString(returnPreSecondToDate(date, second));
    }
