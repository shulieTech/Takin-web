...
public class ApplicationPluginUpgradeRefDAOImpl
    ...
    private LambdaQueryWrapper<ApplicationPluginUpgradeRefEntity> buildQuery(
        LambdaQueryWrapper<ApplicationPluginUpgradeRefEntity> LambdaQueryWrapper) {
    ...
    //    LambdaQueryWrapper<ApplicationPluginUpgradeRefEntity> queryWrapper = this.buildQuery(this
    //    .getCustomerQueryWrapper().lambda());
    ...
    public List<ApplicationPluginUpgradeRefDetailResult> getList(String upgradeBatch) {
        LambdaQueryWrapper<ApplicationPluginUpgradeRefEntity> queryWrapper = this.buildQuery(
