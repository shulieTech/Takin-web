...
CREATE TABLE stresstest_shard_r.t_engine_metrics_all (
  `time` Int64,
  `transaction` String,
  `test_name` String,
  `count` Int16,
...
CREATE TABLE stresstest_shard_r.t_engine_pressure_all (
  `time` Int64,
  `transaction` String,
  `avg_rt` Decimal64 ( 4 ),
  `avg_tps` Decimal64 ( 4 ),
...
CREATE TABLE stresstest_shard_r.t_app_base_data_all (
  `time` Int64,
  `agent_id` String,
  `app_ip` String,
  `app_name` String,
...
CREATE TABLE stresstest_shard_r.t_performance_base_data_all (
  `time` Int64,
  `timestamp` Int64,
  `total_memory` Int64,
  `perm_memory` Int64,
...
CREATE TABLE stresstest_shard_r.trace_metrics_all (
  `time` Int64,
  `edgeId` String,
  `clusterTest` String,
  `service` String,
...
CREATE TABLE stresstest_shard_r.trace_e2e_assert_metrics_all (
  `time` Int64,
  `nodeId` String,
  `exceptionType` String,
  `traceId` String,
