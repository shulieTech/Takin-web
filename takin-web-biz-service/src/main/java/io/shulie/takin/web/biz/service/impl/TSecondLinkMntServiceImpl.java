...
import com.pamirs.takin.common.constant.LinkLevelEnum;
...
public class TSecondLinkMntServiceImpl extends CommonService implements TSecondLinkMntService {
    ...
    public void saveSecondLink(TSecondLinkMnt secondLinkMnt) throws Exception {
        ...
        if (linkExist > 0) {
            throw new TakinModuleException(TakinErrorEnum.CONFCENTER_SECOND_LINK_DUPICATE_EXCEPTION);
        } else {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public void updateLinkinfo(TSecondLinkMnt secondLinkMnt) throws TakinModuleException {
        ...
        if (!Objects.isNull(originSecondLinkMnt)) {
            ...
            LOGGER.info(TakinErrorEnum.CONFCENTER_NOT_FOUND_SECOND_LINKID_EXCEPTION.getErrorMessage());

            throw new TakinModuleException(TakinErrorEnum.CONFCENTER_NOT_FOUND_SECOND_LINKID_EXCEPTION);
        }
    }
