 ...
 */
@Deprecated
public class LettuceSingleTemplateParser extends AbstractTemplateParser{
    ...
    public Class<?>  getSupperClass() {
        return  RedisTemplate.LettuceSingleTemplate.class;
    }
    ...
    public <T extends Template> T convertTemplate(AppShadowDatabaseDTO dto) {
        ...
        RedisTemplate.LettuceSingleTemplate lettuceSingleTemplate = JSONObject.parseObject(attachment, RedisTemplate.LettuceSingleTemplate.class);
        return (T) lettuceSingleTemplate;
    }
}
