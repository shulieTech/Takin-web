...
public class LinkMntController {
    ...
    public ResponseEntity<Object> saveBasicLink(@RequestBody @Valid TLinkServiceMntVo tLinkServiceMntVo,
        ...
        try {
            ...
            return ResponseError.create(TakinErrorEnum.CONFCENTER_ADD_LINK_EXCEPTION.getErrorCode(),
                TakinErrorEnum.CONFCENTER_ADD_LINK_EXCEPTION.getErrorMessage());
        }
    }
    ...
    public ResponseEntity<Object> queryBasicLinkList(@RequestBody Map<String, Object> paramMap) {
        try {
            ...
            return ResponseError.create(TakinErrorEnum.CONFCENTER_QUERY_LINKLIST_EXCEPTION.getErrorCode(),
                TakinErrorEnum.CONFCENTER_QUERY_LINKLIST_EXCEPTION.getErrorMessage());
        }
    }
    ...
    public ResponseEntity<Object> queryLinkByLinkId(@RequestParam("linkId") String linkId) {
        try {
            ...
            return ResponseError.create(TakinErrorEnum.CONFCENTER_QUERY_LINKDETAIL_EXCEPTION.getErrorCode(),
                TakinErrorEnum.CONFCENTER_QUERY_LINKDETAIL_EXCEPTION.getErrorMessage());
        }
    }
    ...
    public ResponseEntity<Object> deleteBasicLinkByLinkIds(@RequestParam("linkIds") String linkIds) {
        try {
            if (StringUtils.isEmpty(linkIds)) {
                return ResponseError.create(TakinErrorEnum.CONFCENTER_DELETE_LINK_PARAMLACK.getErrorCode(),
                    TakinErrorEnum.CONFCENTER_DELETE_LINK_PARAMLACK.getErrorMessage());
            }
            ...
            return ResponseError.create(TakinErrorEnum.CONFCENTER_DELETE_LINK_EXCEPTION.getErrorCode(),
                TakinErrorEnum.CONFCENTER_DELETE_LINK_EXCEPTION.getErrorMessage());
        }
    }
    ...
    public ResponseEntity<Object> queryLinkRankList() {
        try {
            ...
            return ResponseError.create(TakinErrorEnum.CONFCENTER_QUERY_LINKRANK_EXCEPTION.getErrorCode(),
                TakinErrorEnum.CONFCENTER_QUERY_LINKRANK_EXCEPTION.getErrorMessage());
        }
    }
    ...
    public ResponseEntity<Object> updateLinkinfo(@RequestBody @Valid TLinkServiceMntVo tLinkServiceMntVo,
        ...
        try {
            ...
            return ResponseError.create(TakinErrorEnum.CONFCENTER_UPDATE_LINKINFO_EXCEPTION.getErrorCode(),
                TakinErrorEnum.CONFCENTER_UPDATE_LINKINFO_EXCEPTION.getErrorMessage());
        }
    }
    ...
    public ResponseEntity<Object> deleteLinkInterfaceByLinkServiceId(
        ...
        try {
            if (StringUtils.isEmpty(linkServiceIds)) {
                return ResponseError.create(TakinErrorEnum.CONFCENTER_DELETE_LINKSERVICE_PARAMLACK.getErrorCode(),
                    TakinErrorEnum.CONFCENTER_DELETE_LINKSERVICE_PARAMLACK.getErrorMessage());
            }
            ...
            return ResponseError.create(TakinErrorEnum.CONFCENTER_DELETE_LINKSERVICE_EXCEPTION.getErrorCode(),
                TakinErrorEnum.CONFCENTER_DELETE_LINKSERVICE_EXCEPTION.getErrorMessage());
        }
    }
    ...
    public ResponseEntity<Object> queryLinkByLinkType(@RequestBody Map<String, Object> paramMap) {
        try {
            ...
            return ResponseError.create(TakinErrorEnum.CONFCENTER_QUERY_LINKBYLINKTYPE_EXCEPTION.getErrorCode(),
                TakinErrorEnum.CONFCENTER_UPDATE_LINKINFO_EXCEPTION.getErrorMessage());
        }
    }
    ...
    public ResponseEntity<Object> queryLinkModuleList() {
        try {
            ...
            return ResponseError.create(TakinErrorEnum.CONFCENTER_QUERY_LINKMODULE_EXCEPTION.getErrorCode(),
                TakinErrorEnum.CONFCENTER_QUERY_LINKMODULE_EXCEPTION.getErrorMessage());
        }
    }
    ...
    public ResponseEntity<Object> getWhiteList() {
        try {
            ...
            return ResponseError.create(TakinErrorEnum.CONFCENTER_QUERY_WHITELIST_EXCEPTION.getErrorCode(),
                TakinErrorEnum.CONFCENTER_QUERY_WHITELIST_EXCEPTION.getErrorMessage());
        }
    }
    ...
    public ResponseEntity<Object> queryCalcVolumeList() {
        try {
            ...
            return ResponseError.create(TakinErrorEnum.CONFCENTER_QUERY_VOLUME_CALC_EXCEPTION.getErrorCode(),
                TakinErrorEnum.CONFCENTER_QUERY_VOLUME_CALC_EXCEPTION.getErrorMessage());
        }
    }
    ...
    public ResponseEntity<Object> queryLinkHeaderList() {
        try {
            ...
            return ResponseError.create(TakinErrorEnum.CONFCENTER_QUERY_LINK_HEADER_EXCEPTION.getErrorCode(),
                TakinErrorEnum.CONFCENTER_QUERY_LINK_HEADER_EXCEPTION.getErrorMessage());
        }
    }
    ...
    public ResponseEntity<Object> querySecondLinkByModule(@RequestParam("linkModule") String linkModule) {
        ...
        try {
            ...
            return ResponseError.create(
                TakinErrorEnum.CONFCENTER_QUERY_LINK_SECONDLINK_BY_MODULE_EXCEPTION.getErrorCode(),
                TakinErrorEnum.CONFCENTER_QUERY_LINK_SECONDLINK_BY_MODULE_EXCEPTION.getErrorMessage());
        }
    }
