...
INSERT IGNORE INTO `t_pradar_zk_config` (`id`, `zk_path`, `type`, `value`, `remark`, `create_time`, `modify_time`, `is_deleted`) VALUES (8, '/pradar/config/jtl/fileEnable', 'Boolean', 'true', '是否输出jtl文件', '2021-07-08 15:42:53', '2021-07-08 15:42:53', 0);
INSERT IGNORE INTO `t_pradar_zk_config` (`id`, `zk_path`, `type`, `value`, `remark`, `create_time`, `modify_time`, `is_deleted`) VALUES (9, '/pradar/config/jtl/errorOnly', 'Boolean', 'false', 'jtl文件是否只输出异常信息', '2021-07-08 15:43:22', '2021-07-08 15:43:22', 0);
INSERT IGNORE INTO `t_pradar_zk_config` (`id`, `zk_path`, `type`, `value`, `remark`, `create_time`, `modify_time`, `is_deleted`) VALUES (10, '/pradar/config/jtl/timeoutOnly', 'Boolean', 'false', 'jtl是否只输出超过固定接口调用时长的日志', '2021-07-08 15:43:53', '2021-07-08 15:43:53', 0);
INSERT IGNORE INTO `t_pradar_zk_config` (`id`, `zk_path`, `type`, `value`, `remark`, `create_time`, `modify_time`, `is_deleted`) VALUES (11, '/pradar/config/jtl/timeoutThreshold', 'Int', '300', '接口调用时长阈值', '2021-07-08 15:44:22', '2021-07-08 15:44:22', 0);
INSERT IGNORE INTO `t_pradar_zk_config` (`id`, `zk_path`, `type`, `value`, `remark`, `create_time`, `modify_time`, `is_deleted`) VALUES (12, '/pradar/config/jtl/cutoff', 'Boolean', 'false', 'jtl报文日志是否截断', '2021-07-08 15:44:44', '2021-07-08 15:44:44', 0);
